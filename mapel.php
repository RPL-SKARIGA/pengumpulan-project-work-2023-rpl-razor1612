                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-inline-flex px-2 btn btn-primary">
                            <a href="create_mapel.php" class="d-inline-flex px-2 btn btn-primary">
                                Tambah Mapel
                            </a>
                        </div><br><br>
                        ...
                        <ul class="navbar-nav ml auto"><br>
                            ...
                            <div class="col-md-12 table-responsive">
                                ...
                                if (isset($_POST['search'])) {
                                    $cari = $_POST['cari'];
                                    $sql = "SELECT * FROM mata_pelajaran WHERE hari LIKE '%$cari%' OR nama_mapel LIKE '%$cari%'";
                                } else {
                                    $sql = "SELECT * FROM mata_pelajaran ORDER BY id_guru ASC, hari ASC";
                                }

                                $distinctHariQuery = "SELECT DISTINCT hari FROM mata_pelajaran";
                                $distinctHariResult = $pdo->query($distinctHariQuery);
                                $HariButtons = [];

                                while ($distinctHariRow = $distinctHariResult->fetch(PDO::FETCH_ASSOC)) {
                                    $HariButtons[$distinctHariRow['hari']] = true;
                                }
                                ...
                                if ($result = $pdo->query($sql)) {
                                    if ($result->rowCount() > 0) {
                                        ...
                                        echo "<th width='150px'>Jam Pelajaran</th>";
                                        echo "<th width='250px'>Nama Mata Pelajaran</th>";
                                        echo "<th width='40px'>Ruang</th>";
                                        echo "<th width='50px'>Id Guru</th>";
                                        ...
                                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                            if ($currentHari != $row['hari']) {
                                                echo "<tr><td colspan='10' class='font-weight-bold'>$row[hari]</td></tr>";
                                                $currentHari = $row['hari'];
                                            }
                                            echo "<tr>";
                                            echo "<td>" . ++$nourut . "</td>";
                                            echo "<td>" . $row['id_matapelajaran'] . "</td>";
                                            echo "<td>" . $row['jam'] . "</td>";
                                            ...
                                            echo "<form action='update_mapel.php' method='get'>";
                                            echo "<input type='hidden' name='nama_mapel' value='" . $row['nama_mapel'] . "'>";
                                            echo "<input type='hidden' name='id_matapelajaran' value='" . $row['id_matapelajaran'] . "'>";
                                            ...
                                            echo "<form action='delete_mapel.php' method='get'>";
                                            echo "<input type='hidden' name='nama_mapel' value='" . $row['nama_mapel'] . "'>";
                                            echo "<input type='hidden' name='id_matapelajaran' value='" . $row['id_matapelajaran'] . "'>";
                                        ...
                                        echo "<p class='lead'><em>Tidak ada mapel</em></p>";
                                    }
                                } else {
