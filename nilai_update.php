...
$nama_siswa = $kelas = $nama_mapel = $jurusan = $idguru = $nilai = "";
$nama_siswa_err = $kelas_err = $nama_mapel_err = $jurusan_err = $id_guru_err = $nilai_err = "";
...
if (isset($_POST["id_nilai"]) && !empty($_POST["id_nilai"])) {
    ...
    if (empty($input_nama_siswa)) {
        $nama_siswa_err = '<span style="color: red;">Silakan masukkan nama</span>';
    } else {
    ...
    if (empty($input_kelas)) {
        $kelas_err = '<span style="color: red;">Silakan masukkan kelas</span>';
    } else {
        $kelas = $input_kelas;
    }
    ...
    if (empty($input_nilai)) {
        $nilai_err = '<span style="color: red;">Silakan masukkan nilai</span>';
    } else {
        $nilai = $input_nilai;
    }

    if (empty($nama_siswa_err) && empty($kelas_err) && empty($jurusan_err) && empty($nama_mapel_err) && empty($id_guru_err) && empty($nilai_err)) {
        $sql = "UPDATE nilai SET nama_siswa = :nama_siswa, kelas = :kelas, jurusan = :jurusan, nama_mapel = :nama_mapel, id_guru = :id_guru, nilai = :nilai WHERE id_nilai = :id_nilai";
    ...
    if (isset($_GET["id_nilai"]) && !empty(trim($_GET["id_nilai"]))) {
        ...
        if ($stmt = $pdo->prepare($sql)) {
            ...
            $stmt->bindParam("id_nilai", $param_id);
