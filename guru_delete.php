...
if (isset($_POST["id_guru"]) && !empty($_POST["id_guru"])) {
    ...
    if ($stmt = $pdo->prepare($sql)) {
        ...
        $param_id_guru = trim($_POST["id_guru"]);
        if ($stmt->execute()) {
