...
if ($stmtGuru->execute()) {
    $resultGuru = $stmtGuru->fetch(PDO::FETCH_ASSOC);
    $totalGuru = $resultGuru['total_guru'];
} else {
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="siswa.php" class="btn btn-primary btn-sm mt-2">Detail</a>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="kelas.php" class="btn btn-danger btn-sm mt-2">Detail</a>
                                        </div>
                                        <div class="col-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                                fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="mapel.php" class="btn btn-success btn-sm mt-2">Detail</a>
                                        </div>
                                        <div class="col-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                            ...
                            <div class="card border-left-custom shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div
                                                class="text-xs font-weight-bold text-custom text-uppercase mb-1 text-guru">
                                                Total Guru
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $totalGuru; ?>
                                            </div>
                                            <a href="guru.php" class="btn btn-purple btn-sm mt-2">Detail</a>
                                        </div>
                                        <div class="col-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                                fill="currentColor" class="bi bi-book-fill" viewBox="0 0 16 16">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="nilai.php" class="btn btn-info btn-sm mt-2">Detail</a>
                                        </div>
                                        <div class="col-auto">
