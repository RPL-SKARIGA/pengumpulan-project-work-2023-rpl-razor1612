                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-inline-flex px-2 btn btn-primary">
                            <a href="nilai_create.php" class="d-inline-flex px-2 btn btn-primary">
                                Tambah Data Nilai
                            </a>
                        </div><br><br>
                        ...
                        <ul class="navbar-nav ml auto"><br>
                            ...
                            <div class="col-md-12 table-responsive">
                                ...
                                if (isset($_POST['search'])) {
                                    $cari = $_POST['cari'];
                                    $sql = "SELECT * FROM nilai WHERE nama_mapel LIKE '%$cari%' OR nama_siswa LIKE '%$cari%'";
                                } else {
                                    $sql = "SELECT * FROM nilai ORDER BY jurusan ASC, id_nilai ASC";
                                }

                                $distinctMapelQuery = "SELECT DISTINCT nama_mapel FROM nilai";
                                $distinctMapelResult = $pdo->query($distinctMapelQuery);
                                $MapelButtons = [];

                                while ($distinctMapelRow = $distinctMapelResult->fetch(PDO::FETCH_ASSOC)) {
                                    $MapelButtons[$distinctMapelRow['nama_mapel']] = true;
                                }
                                ...
                                if ($result = $pdo->query($sql)) {
                                    if ($result->rowCount() > 0) {
                                        ...
                                        echo "<th width='250px'>Siswa</th>";
                                        echo "<th width='50px'>Kelas</th>";
                                        echo "<th width='250px'>Jurusan</th>";
                                        echo "<th width='100px'>ID Guru</th>";
                                        echo "<th width='50px'>Nilai</th>";
                                        ...
                                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                            if ($currentMapel != $row['nama_mapel']) {
                                                echo "<tr><td colspan='10' class='font-weight-bold'>$row[nama_mapel]</td></tr>";
                                            ...
                                            $nilai = $row['nilai'];
                                            if ($nilai >= 0 && $nilai <= 75) {
                                                echo "<td class='nilai-merah'>" . $nilai . "</td>";
                                            } elseif ($nilai >= 76 && $nilai <= 100) {
                                                echo "<td class='nilai-hitam'>" . $nilai . "</td>";
                                            } else {
                                                echo "<td>" . $nilai . "</td>";
                                            }
                                            echo "<td>";
                                            echo "<div class='d-flex'>";
                                            echo "<form action='nilai_update.php' method='get'>";
                                            echo "<input type='hidden' name='id_nilai' value='" . $row['id_nilai'] . "'>";
                                            echo "<input type='hidden' name='nama_siswa' value='" . $row['nama_siswa'] . "'>";
                                            ...
                                            echo "<form action='nilai_delete.php' method='get'>";
                                            echo "<input type='hidden' name='id_nilai' value='" . $row['id_nilai'] . "'>";
                                            echo "<input type='hidden' name='nama_siswa' value='" . $row['nama_siswa'] . "'>";
