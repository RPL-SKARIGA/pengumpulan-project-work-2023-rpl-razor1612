                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-inline-flex px-2 btn btn-primary">
                            <a href="siswa_create.php" class="d-inline-flex px-2 btn btn-primary">
                                Tambah Data Siswa
                            </a>
                        </div><br><br>
                        ...
                        <ul class="navbar-nav ml auto"><br>
                            ...
                            <div class="col-md-12 table-responsive">
                                ...
                                if (isset($_POST['search'])) {
                                    $cari = $_POST['cari'];
                                    $sql = "SELECT * FROM siswa WHERE nama_siswa LIKE '%$cari%'";
                                } else {
                                    $sql = "SELECT * FROM siswa ORDER BY jurusan ASC, id_siswa ASC";
                                }

                                $distinctJurusanQuery = "SELECT DISTINCT jurusan FROM siswa";
                                $distinctJurusanResult = $pdo->query($distinctJurusanQuery);
                                $jurusanButtons = [];

                                while ($distinctJurusanRow = $distinctJurusanResult->fetch(PDO::FETCH_ASSOC)) {
                                    $jurusanButtons[$distinctJurusanRow['jurusan']] = true;
                                }
                                ...
                                if ($result = $pdo->query($sql)) {
                                    if ($result->rowCount() > 0) {
                                        ...
                                        echo "<th width='80px'>NIS</th>";
                                        echo "<th width='250px'>Nama Siswa</th>";
                                        echo "<th width='140px'>Kelamin</th>";
                                        echo "<th width='0px'>Kelas</th>";
                                        echo "<th width='250px'>Jurusan</th>";
                                        echo "<th width='250px'>Wali</th>";
                                        ...
                                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                            if ($currentJurusan != $row['jurusan']) {
                                                echo "<tr><td colspan='10' class='font-weight-bold'>$row[jurusan]</td></tr>";
                                                $currentJurusan = $row['jurusan'];
                                            }
                                            ...
                                            echo "<form action='siswa_update.php' method='get'>";
                                            echo "  <input type='hidden' name='id_siswa' value='" . $row['id_siswa'] . "'>";
                                            ...
                                            echo "<form action='siswa_delete.php' method='get'>";
                                            echo "<input type='hidden' name='id_siswa' value='" . $row['id_siswa'] . "'>";
