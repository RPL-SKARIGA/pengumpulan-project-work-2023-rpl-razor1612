                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-inline-flex px-2 btn btn-primary">
                            <a href="guru_create.php" class="d-inline-flex px-2 btn btn-primary">
                                Tambah Guru
                            </a>
                        </div><br><br>
                        ...
                        <div class="col-md-12 table-responsive">
                            ...
                            if (isset($_POST['search'])) {
                                $cari = $_POST['cari'];
                                $sql = "SELECT * FROM guru WHERE nama_guru LIKE '%$cari%'";
                            } else {
                            ...
                            if ($result = $pdo->query($sql)) {
                                if ($result->rowCount() > 0) {
                                    ...
                                    echo "<th width='100px'>Guru</th>";
                                    echo "<th width='150px'>No Telepon</th>";
                                    echo "<th width='10px'>Action</th>";
                                    echo "</tr>";
                                    echo "</thead>";
                                    echo "</tbody>";
                                    ...
                                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        echo "<form action='guru_update.php' method='get'>";
                                        echo "<input type='hidden' name='nama_guru' value='" . $row['nama_guru'] . "'>";
                                        echo "<input type='hidden' name='id_guru' value='" . $row['id_guru'] . "'>";
                                        ...
                                        echo "<form action='guru_delete.php' method='get'>";
                                        echo "<input type='hidden' name='nama_guru' value='" . $row['nama_guru'] . "'>";
                                        echo "<input type='hidden' name='id_guru' value='" . $row['id_guru'] . "'>";
                                    ...
                                    echo "<p class='lead'><em>Tidak ada nama</em></p>";
                                }
                            } else {
