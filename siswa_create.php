...
if (isset($_POST["id_siswa"]) && !empty($_POST["id_siswa"])) {
    ...
    if (empty($nis_err) && empty($pass_err) && empty($nama_siswa_err) && empty($kelamin_err) && empty($kelas_err) && empty($jurusan_err)) {
        $sql = "INSERT INTO siswa (nis, password, nama_siswa, kelamin, kelas, jurusan, wali) VALUES (:nis, :password, :nama_siswa, :kelamin, :kelas, :jurusan, :wali)";
                ...
                <div class="card shadow mb-4 p-5">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
                        ...
                        <div class="form-group <?php echo (!empty($kelamin_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="radio" id="Laki-Laki" name="kelamin" value="Laki-Laki" <?php echo ($kelamin === 'Laki-Laki') ? 'checked' : ''; ?>>
                            <label for="Laki-Laki">Laki-Laki</label>
                            <input type="radio" id="Perempuan" name="kelamin" value="Perempuan" <?php echo ($kelamin === 'Perempuan') ? 'checked' : ''; ?>>
